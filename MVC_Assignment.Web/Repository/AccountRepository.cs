...
using MVC_Assignment_1.Service;
using System;
...
namespace MVC_Assignment_1.Repository
{
    public class AccountRepository : IAccountRepository
    {
        ...
        public AccountRepository(UserManager<ApplicationUser> userManager, 
            SignInManager<ApplicationUser> signInManager, IUserService userService, IEmailService emailService, IConfiguration configuration)
        {
